                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="company" type="text" class="form-control" id="company" value="<?php echo $teacher['last_name'];?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="job" type="text" class="form-control" id="Job" value="<?php echo $_SESSION['role'];?>">
                      </div>
                    </div>
