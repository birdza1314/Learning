                        ...
                        if ($topics) {
                            foreach ($topics as $topic) {
                                ...
                                <div class="mt-5">
                                    ...
                                    <?php
                                    // ตรวจสอบและแสดงข้อมูลตามประเภทของกิจกรรม
                                    ...
                                    ?>
                                        ...
                                        <div class="card border rounded-3 shadow-sm">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="d-flex justify-content-end mt-3 ">
                                                    <button type="button" class="btn btn-outline-success me-2 " onclick="viewQuizResults(<?= $quiz['quiz_id']; ?>)">
                                                        ผลการสอบ
                                                    </button>
                                        ...
                                        if ($now > $deadline) {
                                            ...
                                            $cardClass = 'card border rounded-3 shadow-sm  text-danger';
                                        } else {
                                            // ถ้ายังไม่เกินเวลาส่งงาน ให้ใช้คลาสเดิม
                                            $cardClass = 'card border rounded-3 shadow-sm ';
                                        }
                                        ?>
                                        <div class="col-lg-12">
                                            <div class="<?= $cardClass; ?>">
